...
type Adapter interface {
	...
	// Add a user to your friend's address book
	FriendAdd(fir *t.Friendcontact) error
	// Get the user's friend address book
	//FriendGet(uid t.Uid) error
	// Delete the user from the friends' address book
	//FriendDelete(uid t.Uid) error

	// Blacklist

	// Add a user to the blacklist of address book
	//BlacklistAdd(user t.Uid)
	// Get the blacklist of a user's address book
	//BlacklistGet(uid t.Uid)
	// Delete a user from the blacklist of address book
	//BlacklistDelete(uid t.Uid)
}
