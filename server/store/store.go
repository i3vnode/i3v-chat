...
// friendsMapper is a concrete type implementing FriendsPersistenceInterface.
...
func (friendsMapper) Add(fir *types.Friendcontact) error {

	return adp.FriendAdd(fir)
	//return nil
}

func (friendsMapper) Get(uid types.Uid) error {

	//return adp.FriendAdd(uid)
	return nil
}

func (friendsMapper) Delete(uid types.Uid) error {
