...
# See https://github.com/i3vnode/i3v-chat/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/i3vnode/i3v-chat/rest-auth/">https://github.com/i3vnode/i3v-chat/rest-auth/</a> for details.'
